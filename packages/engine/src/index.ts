 ...
 * independently-verifiable, replayable evidence chain over a governed work
 * spine. This package is the shared brain behind every Reef surface (CLI, IDE,
 * Web) — the surfaces are thin; the governance lives here.
 */
